...
const certificates = [
  
  {
    ...
    description:"completed the Digital Productivity course, gaining essential skills in modern productivity tools and digital workflows crucial for effective remote and office-based work",
  ...
  {
    title:"JavaSciprt Essentials",
    img:"/certificate/Javascript test certificate.png",
    description:"passed a JavaScript certification test through a YouTube-based course, demonstrating a solid grasp of JavaScript syntax, logic, and DOM manipulation.",
  ...
  },
  {
    ...
    description:"completed a hands-on internship focused on web development, showcasing diligence and technical capability in developing responsive web applications",
  ...
  },
  {
    ...
    description:"completed a project-based course on React.js, covering the fundamentals of component-based architecture and client-side rendering.",
    issuedBy:"Coursera",
    date:"21 Feb 2025",
    link:"https://drive.google.com/file/d/1c3m30ScsleWgS8YAiY9DBH1LgbJ7x4ON/view?usp=sharing",
  },
  {
    title:"Fundametals of Cybersecurity",
    img:"/certificate/zalar certificate.png",
    description:"completed training in cybersecurity fundamentals, focusing on core concepts like threat management, network security, and secure practices.",
  ...
  },
  {
    ...
    description:"successfully completed a 10-week virtual internship in Full Stack Web Development, demonstrating core competencies in front-end and back-end web technologies",
...
export default function Certificates() {
  ...
  return (
    <section id="certificates" className="py-20 bg-white dark:bg-[#111] px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 bg-gray-100 dark:bg-[#1a1a1a] p-6 sm:p-10 rounded-xl shadow-md transition-all duration-500">
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">{cert.title}</h3>
            ...
            <div className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
              ...
              <p>
                <strong className="text-gray-800 dark:text-gray-200">Date:</strong> {cert.date}
              </p>
              <p>
                <a
                  href={cert.link}
